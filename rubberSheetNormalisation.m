...
function [ring,polar_array] = rubberSheetNormalisation(image, x_iris, y_iris, r_iris,...
    x_pupil, y_pupil, r_pupil,image_filename, radpixels, angulardiv)

orig=image;

[ring] = extarct_circle(orig,[round(x_pupil),round(y_pupil)],[round(x_iris),round(y_iris)],round(r_pupil),round(r_iris));
